...
function extractValues(formData: FormData) {
  ...
  return {
    ...
    materialText: str("materialText"),
    jewelryLengthText: str("jewelryLengthText"),
    materials: formData.getAll("materials").filter((v): v is string => typeof v === "string"),
  ...
  if (!parsed.success) {
    ...
    return {
      ...
      fieldErrors: {
        ...
        materials: flat.materials?.[0],
        materialText: flat.materialText?.[0],
        jewelryLengthText: flat.jewelryLengthText?.[0],
        productType: flat.productType?.[0],
        slug: flat.slug?.[0],
    ...
    await db.$transaction([
      db.product.update({
        ...
        data: {
          ...
          jewelryLengthText: parsed.data.jewelryLengthText,
